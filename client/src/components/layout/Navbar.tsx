...
export function Navbar() {
  ...
  return (
    <>
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            >
              <Link
                ...
                style={{
                  color: "#7a7468",
                  opacity: location === "/services" ? 1 : 0.8,
                }}
              >
                Services
              </Link>
              ...
              <Link
                ...
                style={{
                  color: "#7a7468",
                  opacity: location === "/intelligence" ? 1 : 0.8,
                }}
              >
                Intelligence
              </Link>
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-0 z-40 pt-24 px-6 flex flex-col"
          style={{ backgroundColor: "#0c0b09" }}
        >
          <div
            className="flex flex-col gap-8 text-2xl font-heading"
            style={{ color: "#EDE8DF" }}
          >
            ...
            <Link href="/intelligence" onClick={closeMenu}>
              Intelligence
            </Link>
          ...
          <div className="mt-auto pb-12 flex flex-col gap-4">
            ...
            <Link
              ...
              onClick={closeMenu}
              className="w-full text-center px-5 py-4 rounded"
              style={{ backgroundColor: "#C4941F", color: "#0c0b09" }}
            >
              Apply Now
            </Link>
          </div>
